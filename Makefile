...
swap_t2_for_t1_test: venv/bin/activate
	. ./config.sh; . venv/bin/activate; python3 tests/swap_t2_for_t1_test.py

withdraw_liq_test: venv/bin/activate
	. ./config.sh; . venv/bin/activate; python3 tests/withdraw_liquidity_test.py

withdraw_protocol_fees_test: venv/bin/activate
	. ./config.sh; . venv/bin/activate; python3 tests/withdraw_protocol_fees_test.py
